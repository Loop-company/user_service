...
const file_proto_user_proto_rawDesc = "" +
	...
	"\vUserService\x12?\n" +
	"\n" +
	"GetProfile\x12\x17.user.GetProfileRequest\x1a\x18.user.GetProfileResponse\x122\n" +
	"\n" +
	"UpdateName\x12\x17.user.UpdateNameRequest\x1a\v.user.Empty\x126\n" +
	"\fUpdateStatus\x12\x19.user.UpdateStatusRequest\x1a\v.user.Empty\x12B\n" +
	"\vGetSettings\x12\x18.user.GetSettingsRequest\x1a\x19.user.GetSettingsResponse\x12:\n" +
	"\x0eUpdateSettings\x12\x1b.user.UpdateSettingsRequest\x1a\v.user.EmptyB\x1bZ\x19user-service/proto;userpbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	7, // 8: user.UserService.UpdateName:output_type -> user.Empty
	7, // 9: user.UserService.UpdateStatus:output_type -> user.Empty
	5, // 10: user.UserService.GetSettings:output_type -> user.GetSettingsResponse
	7, // 11: user.UserService.UpdateSettings:output_type -> user.Empty
