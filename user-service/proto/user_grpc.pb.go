...
type UserServiceClient interface {
	...
	UpdateName(ctx context.Context, in *UpdateNameRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *userServiceClient) UpdateName(ctx context.Context, in *UpdateNameRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *userServiceClient) UpdateSettings(ctx context.Context, in *UpdateSettingsRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type UserServiceServer interface {
	...
	UpdateName(context.Context, *UpdateNameRequest) (*Empty, error)
...
func (UnimplementedUserServiceServer) UpdateName(context.Context, *UpdateNameRequest) (*Empty, error) {
...
func (UnimplementedUserServiceServer) UpdateSettings(context.Context, *UpdateSettingsRequest) (*Empty, error) {
