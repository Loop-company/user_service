...
type UserServiceClient interface {
	...
	UpdateName(ctx context.Context, in *UpdateNameRequest, opts ...grpc.CallOption) (*UserEmpty, error)
	UpdateStatus(ctx context.Context, in *UpdateStatusRequest, opts ...grpc.CallOption) (*UserEmpty, error)
...
func (c *userServiceClient) UpdateName(ctx context.Context, in *UpdateNameRequest, opts ...grpc.CallOption) (*UserEmpty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserEmpty)
...
func (c *userServiceClient) UpdateStatus(ctx context.Context, in *UpdateStatusRequest, opts ...grpc.CallOption) (*UserEmpty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserEmpty)
...
type UserServiceServer interface {
	...
	UpdateName(context.Context, *UpdateNameRequest) (*UserEmpty, error)
	UpdateStatus(context.Context, *UpdateStatusRequest) (*UserEmpty, error)
...
func (UnimplementedUserServiceServer) UpdateName(context.Context, *UpdateNameRequest) (*UserEmpty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateName not implemented")
}
func (UnimplementedUserServiceServer) UpdateStatus(context.Context, *UpdateStatusRequest) (*UserEmpty, error) {
